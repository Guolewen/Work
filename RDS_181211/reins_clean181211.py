...
class Reins:
    ...
    def get_col_name(self):
        ...
        if len(index) > 1:
            ...
            pass
        end_index = int()
        for end_index in range(len(split_file)):
            if split_file[end_index] == '問合せ電話番号' or split_file[end_index] == '成約年月日':
                break

        col_names = ['id']
        # deal with abnormal columns 異常処理(/)                                                // written by Lewen, Guo
        for k in range(index, end_index + 1):
            if '/' in split_file[k]:
    ...
    def get_col_data(self, object_num=1):
        ...
        for index in range(len(split_file)):
            if split_file[index] == '問合せ電話番号' or split_file[index] == '成約年月日':
                break
        ...
        # type_index indicates the building type of the objects in text file                    // wriiten by Lewen, Guo
        ...
        if self.browser == 'ie':
            ...
            if split_file[type_index] == '売り・戸建て' or split_file[type_index] == '売り・土地':
                ...
                iterators = [new_index, new_index + 2, new_index + 3, new_index + 4, new_index + 5, new_index + 7,
                             new_index + 7, new_index + 8, new_index + 9, new_index + 10, new_index + 11,
                             new_index + 12,
                ...
                iterators = [new_index, new_index + 2, new_index + 3, new_index + 4, new_index + 5,
                             new_index + 7, new_index + 8, new_index + 9, new_index + 10, new_index + 11,
                             new_index + 12, new_index + 13, new_index + 15, new_index + 16, new_index + 17,
                             new_index + 18, new_index + 19, new_index + 21, new_index + 22, new_index + 23,
                             new_index + 24, new_index + 25, new_index + 26, new_index + 28, new_index + 29,
                             new_index + 30, new_index + 31, new_index + 32, new_index + 33, new_index + 33,
                             new_index + 34]
            elif split_file[type_index] == '成約売り・マンション':

                iterators = [new_index, new_index + 2, new_index + 3, new_index + 4, new_index + 5,
                             new_index + 7, new_index + 8, new_index + 9, new_index + 10, new_index + 11,
                             new_index + 12, new_index + 13, new_index + 15, new_index + 16, new_index + 17,
                             new_index + 18, new_index + 19, new_index + 20, new_index + 21, new_index + 22,
                             new_index + 23, new_index + 24, new_index + 25, new_index + 26, new_index + 27,
                             new_index + 28, new_index + 29, new_index + 30, new_index + 31,
                             new_index + 32, new_index + 33]
            elif split_file[type_index] == '成約売り・戸建て' or split_file[type_index] == '成約売り・土地':

                iterators = [new_index, new_index + 2, new_index + 3, new_index + 4, new_index + 5, new_index + 7,
                             new_index + 7, new_index + 8, new_index + 9, new_index + 10, new_index + 11,
                             new_index + 12, new_index + 12, new_index + 13, new_index + 15, new_index + 16,
                             new_index + 17, new_index + 18, new_index + 19, new_index + 20, new_index+21,new_index + 22, new_index + 23,
                             new_index + 24, new_index + 25, new_index + 26, new_index + 27, new_index + 28,
                             new_index + 29, new_index + 30, new_index + 31, new_index + 32,
                             new_index + 33]
            ...
            if split_file[type_index] == '売り・戸建て' or split_file[type_index] == '売り・土地':
            ...
            elif split_file[type_index] == '成約売り・土地' or split_file[type_index] == '成約売り・戸建て':
                iterators = [new_index, new_index + 5, new_index + 7, new_index + 8, new_index + 10,
                             new_index + 11, new_index + 11, new_index + 13, new_index + 14,
                             new_index + 16, new_index + 17, new_index + 18, new_index + 18,
                             new_index + 20, new_index + 22, new_index + 24, new_index + 25,
                             new_index + 26, new_index + 27, new_index + 28, new_index + 30,
                             new_index + 31, new_index + 32, new_index + 33, new_index + 34,
                             new_index + 35, new_index + 36, new_index + 38, new_index + 39,
                             new_index + 40, new_index + 41, new_index + 42, new_index + 43]
                ...
                iterators = [new_index, new_index + 5, new_index + 7, new_index + 8, new_index + 10,
                             ...
                             new_index + 16, new_index + 17, new_index + 18, new_index + 19,
                             new_index + 22, new_index + 24, new_index + 25,
                             new_index + 26, new_index + 27, new_index + 28, new_index + 29,
                             new_index + 30, new_index + 32, new_index + 33, new_index + 34,
                             new_index + 35, new_index + 36, new_index + 38, new_index + 39,
                             new_index + 40, new_index + 41, new_index + 42, new_index + 43]

        #print("length:", len(iterators) ,"col_names:", len(col_names),iterators)
        list_row = []
        # lag is used to record the number of lag that should be added to original iterator     // written by Lewen, Guo
        lag = 0
        if len(col_names) != len(iterators):
            raise ValueError("error, len(col_names) is not equal to len(iterators)")
        else:
            pass
    ...
    def clean_data(self):
        ...
        """
        split_file = self.read_file()
        # counter the index of total number element '1-100 件目' in this case the index of '100' //written by Lewen, Guo
        obj_number_indicator = split_file.index('件目') - 1
        # object_number is the titak
        object_number = int()
        if int(split_file[obj_number_indicator]) % 100 == 0:
            object_number = 100 + 1
        elif int(split_file[obj_number_indicator]) % 100 != 0:
            # check the number of digits in page_number len('234') <- 3,  len('56') <- 2         //written by Lewen, Guo
            total_page_number = len(split_file[obj_number_indicator])

            # get the last two digits '234' <-   34 + 1    '56' <- 56 + 1                        //written by Lewen, Guo
            object_number = int(split_file[obj_number_indicator][total_page_number-2:]) + 1
